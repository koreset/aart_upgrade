export const featuresHelp = [
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'Premium holiday benefit. Allows a policyholder to skip premium payments subject to limits/restrictions on the timing.   E.g every December or every 12th Premium',
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'These are products that provide cover until death from inception date. Otherwise cover is provided over a given term.',
    product_association: 'All',
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'Base Sum Assured. Must be selected for the fixed base sum assuered. Sum Assured is read from the model point file.',
    product_association: 'All',
    associated_required_tables: 'Model Point File'
  },
  {
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'Optional benefits that may be added to a policy to supplement/compliment the base benefit.',
    product_association: 'All',
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      "Indicates an increase of the lapse rate by the main member's expected mortality rate. This is applicable for a funeral product.",
    product_association: 'Funeral',
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'Cashback benefit is payable upon death of the life assured. Cashback parameters are included in the parameter table.',
    product_association: 'All',
    associated_required_tables: 'Parameters'
  },
  {
  ...
  },
  {
    ...
    description:
      'Sum Assured is projected as the outstanding loan amount over the projection period.',
    product_association: 'Credit Life',
    associated_required_tables: 'Model Point File'
  },
  {
    ...
    'Dependency on Product Features': 'CREDIT_LIFE',
    description:
      'Credit Life Premium Pattern. Premium is calculated as a percentage of the original loan amount.',
    product_association: 'Credit Life',
    associated_required_tables: 'Model Point File'
  },
  {
    ...
    'Dependency on Product Features': 'CREDIT_LIFE',
    description:
      'Credit Life Premium Pattern. Premium decreases in line with the reducing outstanding loan amount. Premium is expressed as a percentage of the outstanding loan amount.',
    product_association: 'Credit Life',
    associated_required_tables: 'Model Point File'
  },
  {
    ...
    'Dependency on Product Features': 'CREDIT_LIFE',
    description:
      'This variable is used as an indicator to calculate and project outstanding sum assured over the projection period.',
    product_association: 'Credit Life',
    associated_required_tables: 'Parameters'
  },
  {
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'This feature indicates that permanent disability benefit is payable on a product.',
    product_association: 'All',
    associated_required_tables: 'Model Point File'
  },
  {
  ...
  },
  {
    ...
    description:
      'Funeral option benefit within a credit life product.Only applicable for a credit life product.',
    product_association: 'Credit Life',
    associated_required_tables: 'Model Point File'
  },
  {
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'Fully paid up benefit is applicable on a product. Premium is not payable once the benefit is triggered.',
    product_association: 'All',
    associated_required_tables: 'Model Point File'
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'This feature is applicable on a product where the life assured may reduce sum assured and/or premium to a non-zero amount',
    product_association: 'All',
    associated_required_tables: 'Model Point File'
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'Premium waiver benefit upon death of the life assured. For example applicable on education or savings products.',
    product_association: 'All',
    associated_required_tables: 'Model Point File'
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'This feature indicates surrender benefit on a product when a policy is surrendered. Usually this is calculated on a proportionate basis.',
    product_association: 'All',
    associated_required_tables: 'Model Point File'
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'This feature identifies products that offer benefits that are linked to a value of a given underlying fund.',
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'This feature identifies products that allow the policy to participate in profits by means of bonus distributions.',
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      'The actuarial reserve for the risk benefit of the product within a  unit linked product.',
    product_association: 'Unit Linked',
    associated_required_tables: 'Model Point File'
  },
  {
  ...
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      "This feature is applicable on a product where a premium waiver benefit is offered upon confirmation of the policyholder's disability state.",
    product_association: 'All',
    associated_required_tables: 'Model Point File'
  },
  {
    ...
    'Dependency on Product Features': '',
    description:
      '3 tier reinsurance structure. Configurable for quota share, surplus reinsurance and/or hybrid reinsurance. The User is required to specify lower and upper limit exposure levels and ceding proportions in each of the levels. Also flat premium proportion is required. All these variables form part of the Reinsurance table',
    product_association: 'All',
