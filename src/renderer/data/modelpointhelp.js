export const modelpointHelp = [
  {
    "data_variable": "Year",
    "description": "This variable is used to differentiate parameters/assumptions and allows referencing by year. Parameter tables, Assumption tables, model point files and other non-static tables are tagged by year accordingly. The user is required to choose year from the drop down list, and assign it to the table before uploading it. The assigned year is used to reference or choose appropriate assumptions in setting up valuation runs. eg. AOS runs.",
    "data_type": "int",
    "constraints": "N/A",
  ...
  },
  {
    ...
    "description": "Unique code that is used to identify a product. The product code is used to read product specific assumptions or parameters.",
    "data_type": "string",
    "constraints": "N/A",
  ...
  },
  {
    ...
    "description": "The month during which a contract between a life assured and an insurer commenced. Together with the commencement year, commencement month is used to identify lockedin discount rates. Month is concatenated with the Commencement Year as the indentifier for the IFRS17 Lockedin Yield Curve.",
    "data_type": "int",
    "constraints": [
      1,
      12
  ...
  },
  {
    ...
    "description": "Main Member's Gender. Male or Female Input Variable. Or Characters \"F\" and \"M\" are also acceptable.",
    "data_type": "string",
    "constraints": "Male, Female\nM, F",
    "note": "Can be used as a rating factor in transition tables."
  },
  {
    ...
    "description": "Policy count as at the valuation date. Usually 1 is assigned unless model point weighting is assumed. The latter option being more relevant for pricing purposes.",
    "data_type": "int",
    "constraints": [
      0,
      1
  ...
  },
  {
    ...
    "description": "Contractual term, as at the loan issue date, over which the loan is due for full repayment.",
    "data_type": "int",
    "constraints": "[0, )",
  ...
  },
  {
    ...
    "description": "Annualised base premium amount that is payable on a policy as at the valuation date. Premium escalations allowed for in a separate variable. Single Premium is stated as is.",
    "data_type": "float64",
    "constraints": "[0,  )",
  ...
  },
  {
    ...
    "description": "A period over which the insurance cover is limited according to terms and conditions e.g. only accidental risk may be covered during the Waiting Period.",
    "data_type": "int",
    "constraints": "[0, )",
  ...
  },
  {
    ...
    "description": "Number of months a policy has been in force, since inception date, as at the valuation date",
    "data_type": "int",
    "constraints": "[0, )",
  ...
  },
  {
    ...
    "description": "Escalation percentage that the sum assured is increased by on a specified period.",
    "data_type": "float64",
    "constraints": [
      0,
      100
  ...
  },
  {
    ...
    "description": "Frequency in months over which the sum assured is increased by the SumAssuredEscalation percentage in a year.",
    "data_type": "int",
    "constraints": "[0, )",
  ...
  },
  {
    ...
    "description": "How often premiums are paid in a year. 0 for Single Premium, 1 for Annual Premium, 4 for premium payable quarterly, 12 for monthly premium",
    "data_type": "int",
    "constraints": [
      0,
      12
  ...
  },
  {
    ...
    "description": "Boolean paid up indicator. 1 if a policy is in the paid up state and 0 otherwise. Applicable if PaidupOption is 1.",
    "data_type": "ConvertibleBoolean",
    "constraints": "0,1",
  ...
  },
  {
    ...
    "description": "Boolean temporary premium waiver indicator. 1 if temporary premium waiver is effective otherwise 0",
    "data_type": "ConvertibleBoolean",
    "constraints": "0,1",
  ...
  },
  {
    ...
    "description": "1 for initial commission with clawback. Parameters are included in the parameter table. Clawback Table is also required. \n2 for renewal commission. Percentage of Premium Plus Renewal Rand Amount. Parameters are included in the parameter table.",
    "data_type": "int",
    "constraints": "1,2",
  ...
  },
  {
    ...
    "description": "Boolean Cashback option. 1 if cashback option is chosen. Cashback on Survival and Cashback on Death parameters are included in the parameter table.",
    "data_type": "ConvertibleBoolean",
    "constraints": "0,1",
  ...
  },
  {
    ...
    "description": "Rating factor: select period in years eg. 0 for not applicable, 1 for select year 1 etc",
    "data_type": "int",
    "constraints": [
      0,
      1,
  ...
  },
  {
    ...
    "description": "Number of months a benefit payout is deferred by to assess the severity of the sickness. E.g. a period over which the severity of disability is assessed",
    "data_type": "int",
    "constraints": "[0, )",
