export const experienceAnalysis = [
  ...
  },
  {
    ...
    data_type: 'number',
    data_description:
      'Duration in force, measured in months, at the point of exit during the investigation period.',
  ...
  },
  {
    ...
    data_type: 'number',
    data_description:
      'Duration in force, measured in years, at the point of exit during the investigation period.',
  ...
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The date on which the life assured exits age X during the investigation period.',
    data_source:
  ...
  },
  {
    ...
    data_source: ' Int(yearfrac(DateofBirth, DateAtStart)*12) + 1',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_source: ' Int(yearfrac(DateofBirth, DateAtEnd)*12) + 1',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The maximum duration for which the policy was covered during the investigation period.',
    data_source: ' Roundup(yearfrac(DateAtStart, DateAtEnd)*12),0)',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_source: ' Roundup(yearfrac(DateAtStart, DateAtEndAgeX)*12),0)',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_source: 'MaxDuration - AgeXExposure',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_source: 'AgeXExposure * SumAssured',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_source: 'AgeNextExposure * SumAssured',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The expected number of claims occurring at age X within the investigation period, attributable to male lives.',
    data_source: 'AgeXExposure * MortalityRateAtAgeX',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The expected claim amount occurring at age X within the investigation period, attributable to male lives.',
    data_source: 'AmountAgeXExposure * MortalityRateAtAgeX',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The expected number of claims occurring at age X within the investigation period, attributable to female lives.',
    data_source: 'AgeXExposure * MortalityRateAtAgeX',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The expected claim amount occurring at age X within the investigation period, attributable to female lives.',
    data_source: 'AmountAgeXExposure * MortalityRateAtAgeX',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The expected number of claims occurring at age X + 1 within the investigation period, attributable to male lives.',
    data_source: 'AgeNextExposure * MortalityRateAtNextAge',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The expected claim amount occurring at age X + 1 within the investigation period, attributable to male lives.',
    data_source: 'AmountAgeNextExposure * MortalityRateAtNextAge',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The expected number of claims occurring at age X + 1 within the investigation period, attributable to female lives.',
    data_source: 'AgeNextExposure * MortalityRateAtNextAge',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The expected claim amount occurring at age X + 1 within the investigation period, attributable to female lives.',
    data_source: 'expmp.AmountAgeNextExposure * MortalityRateAtNextAge',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'The ratio of number of deaths to the total person-time at risk (or population at risk) over a specified observation period',
    data_source: 'Min(1-Exp(-ActualClaimCount/ExposureCount), 1)',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'Number of months the policy spent in duration year 1 during the investigation period',
    data_source: 'Min(Max(12-DurationIfAtStart, 0), TotalDurationExposure)',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_type: 'number',
    data_description:
      'Number of months the policy spent in duration year 2 during the investigation period',
    data_source:
  ...
  },
  {
    ...
    data_type: 'number',
    data_description:
      'Number of months the policy spent in duration year 3 during the investigation period',
    data_source:
  ...
  },
  {
    ...
    data_type: 'number',
    data_description:
      'Number of months the policy spent in duration year 4 during the investigation period',
    data_source:
  ...
  },
  {
    ...
    data_type: 'number',
    data_description:
      'Number of months the policy spent in duration year 5+ during the investigation period',
    data_source: 'Max(TotalDurationExposure - DurationInYear1,2,3_4, 0)',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_source: '1 - Exp(-Lapses/CentralExposure)',
    data_source_type: 'Calculation Engine'
  },
  {
    ...
    data_source: '1 - Pow(1 - monthlyCrudeLapseRate, 12)',
    data_source_type: 'Calculation Engine'
  }
]
