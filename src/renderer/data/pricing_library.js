export const pricing_library = [
    ...
    },
    {
        ...
        data_type: "number",
        data_description: "discounted expected premium income. Feeds into downstream reserve calculation. Assumes that premium is receipted in advance.",
        data_source: " PremiumIncome(t+1) + ProfDiscountedPremium(t+1)* discountFactor",
        data_source_type: "Calculation Engine",
      },
  ];